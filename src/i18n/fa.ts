...
const customFarsiMessages: TranslationMessages = {
    ...
    pos: {
        ...
        dashboard: {
            ...
            month_history: "تاریخچه ۳۰ روز گذشته",
            new_orders: 'سفارشات جدید',
            pending_reviews: 'نظرات در انتظار',
            all_reviews: 'تمام نظرات',
            new_customers: 'مشتریان جدید',
            all_customers: 'تمام مشتریان',
            pending_orders: 'سفارشات در انتظار',
            order: {
                items:
                    'مشتری %{customer_name}, un poster |||| par %{customer_name}, %{nb_items} کالا',
            },
            welcome: {
                title: 'خوش آمدید',
                subtitle:
                    "اینجا یک متن خیلی جالب داریم.",
                ra_button: 'دکمه را',
                demo_button: 'دکمه دمو',
            },
        },
        menu: {
            sales: 'فروش',
